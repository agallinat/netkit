...
Advanced features include a greedy algorithm for reverse diffusion analysis — predicting optimal seed node sets that maximize signal propagation to a specified set of target nodes — and tools for simulating network robustness under targeted or random node removal, following the framework of [Albert et al., 2000](https://www.nature.com/articles/35019019). Additionally, **netkit** implements node role classification based on within-module and between-module connectivity, as described by [Guimerà & Amaral, 2005](https://www.nature.com/articles/nature03288). 
...
You can install the development version of **netkit** from GitHub using the `devtools` or `remotes` package:
...
- [Introduction to netkit](https://agallinat.github.io/netkit/docs/articles/Introduction.html)
